...
public class PostingService {
    ...
    private PostingDetailDto toPostingDetail(ResultSet resultSet) throws SQLException {
        return new PostingDetailDto(
                ...
                resultSet.getString("env_both_hands"),
                resultSet.getString("env_eyesight"),
                resultSet.getString("env_lstn_talk"),
                resultSet.getString("env_hand_work"),
                resultSet.getString("env_lift_power"),
                resultSet.getString("env_stnd_walk"),
                resultSet.getString("salary_type"),
                resultSet.getString("salary"),
                resultSet.getString("term_date"),
