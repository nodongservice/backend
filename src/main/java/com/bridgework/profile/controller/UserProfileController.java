...
public class UserProfileController {
    ...
    public ResponseEntity<com.bridgework.common.dto.ApiResponse<UserProfileResponseDto>> createProfile(
        ...
        Long userId = currentUserId(authentication);
        return ResponseEntity.ok(com.bridgework.common.dto.ApiResponse.success(userProfileCommandFacade.create(userId, request)));
    }
    ...
    public ResponseEntity<com.bridgework.common.dto.ApiResponse<UserProfileResponseDto>> updateProfile(
        ...
        Long userId = currentUserId(authentication);
        return ResponseEntity.ok(com.bridgework.common.dto.ApiResponse.success(userProfileCommandFacade.update(userId, profileId, request)));
    }
