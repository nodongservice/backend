...
public class UserProfileController {
    ...
    @ApiResponse(responseCode = "200", description = "조회 성공",
            content = @Content(examples = @ExampleObject(
                    value = "[{\"profileId\":3,\"userId\":6,\"isDefault\":true,\"fullName\":\"박지훈(더미-상담기본)\",\"targetJob\":\"고객상담\",\"skills\":[\"고객응대\",\"CRM\",\"문제해결\"],\"disabilityType\":\"청각장애\",\"disabilitySeverity\":\"중등도\",\"disabilityRegisteredYn\":true,\"workTypes\":[\"정규직\"],\"selfIntroduction\":\"고객 감정 완화와 문제 해결에 자신 있습니다.\"}]"
            )))
    ...
    @ApiResponse(responseCode = "200", description = "기본 프로필 변경 성공",
            content = @Content(examples = @ExampleObject(
                    value = "{\"profileId\":4,\"userId\":6,\"isDefault\":true,\"fullName\":\"박지훈(더미-QA전환)\",\"targetJob\":\"고객지원 QA\",\"skills\":[\"품질관리\",\"데이터분석\",\"커뮤니케이션\"]}"
            )))
