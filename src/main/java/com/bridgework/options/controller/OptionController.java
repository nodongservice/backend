...
public class OptionController {
    ...
    @ApiResponse(responseCode = "200", description = "조회 성공",
            content = @Content(examples = @ExampleObject(
                    value = "[{\"code\":\"A\",\"name\":\"사무직\",\"level\":1},{\"code\":\"A01\",\"name\":\"총무\",\"level\":2},{\"code\":\"A0101\",\"name\":\"사무보조\",\"level\":3}]"
            )))
    ...
    @ApiResponse(responseCode = "200", description = "조회 성공",
            content = @Content(examples = @ExampleObject(value = "[{\"value\":\"서울\",\"label\":\"서울\"},{\"value\":\"부산\",\"label\":\"부산\"}]")))
    ...
    @ApiResponse(responseCode = "200", description = "조회 성공",
            content = @Content(examples = @ExampleObject(value = "[{\"value\":\"정규직\",\"label\":\"정규직\"},{\"value\":\"재택/원격\",\"label\":\"재택/원격\"}]")))
    ...
    @ApiResponse(responseCode = "200", description = "조회 성공",
            content = @Content(examples = @ExampleObject(value = "[{\"value\":\"월급\",\"label\":\"월급\"},{\"value\":\"연봉\",\"label\":\"연봉\"}]")))
