...
public class PublicDataSyncController {
    ...
    @ApiResponse(responseCode = "202", description = "요청 접수 성공",
            content = @Content(examples = @ExampleObject(
                    value = "{\"code\":\"SUCCESS\",\"message\":\"요청이 성공했습니다.\",\"result\":{\"requestedAt\":\"2026-05-08T16:50:00+09:00\",\"sourceType\":\"KEPAD_RECRUITMENT\",\"message\":\"동기화 요청이 접수되었습니다. 최종 결과는 Discord 알림으로 전달됩니다.\"}}"
            )))
    public ResponseEntity<com.bridgework.common.dto.ApiResponse<SyncRunAcceptedResponseDto>> runSync(
        ...
        return ResponseEntity.accepted().body(com.bridgework.common.dto.ApiResponse.success(new SyncRunAcceptedResponseDto(
    ...
    @ApiResponse(responseCode = "200", description = "조회 성공",
            content = @Content(examples = @ExampleObject(
                    value = "{\"code\":\"SUCCESS\",\"message\":\"요청이 성공했습니다.\",\"result\":[{\"id\":101,\"sourceType\":\"KEPAD_RECRUITMENT\",\"requestSource\":\"MANUAL\",\"status\":\"SUCCESS\",\"processedCount\":1000,\"newCount\":120,\"updatedCount\":80,\"failedCount\":0,\"errorMessage\":null,\"startedAt\":\"2026-05-08T16:40:00+09:00\",\"endedAt\":\"2026-05-08T16:42:10+09:00\"}]}"
            )))
    public ResponseEntity<com.bridgework.common.dto.ApiResponse<List<SyncLogResponseDto>>> getRecentLogs(
            @RequestParam(name = "sourceType", required = false) PublicDataSourceType sourceType
    ) {
        return ResponseEntity.ok(com.bridgework.common.dto.ApiResponse.success(publicDataSyncService.getRecentLogs(sourceType)));
    }

    @DeleteMapping("/logs")
    @Operation(summary = "동기화 실행 로그 초기화", description = "저장된 동기화 실행 로그를 모두 삭제한다.")
    @ApiResponse(responseCode = "200", description = "초기화 성공",
            content = @Content(examples = @ExampleObject(value = "{\"code\":\"SUCCESS\",\"message\":\"요청이 성공했습니다.\",\"result\":{\"deletedCount\":34}}")))
    public ResponseEntity<com.bridgework.common.dto.ApiResponse<SyncLogResetResponseDto>> resetSyncLogs() {
        long deletedCount = publicDataSyncService.resetSyncLogs();
        return ResponseEntity.ok(com.bridgework.common.dto.ApiResponse.success(new SyncLogResetResponseDto(deletedCount)));
    }
    ...
    @ApiResponse(responseCode = "200", description = "조회 성공",
            content = @Content(examples = @ExampleObject(
                    value = "{\"code\":\"SUCCESS\",\"message\":\"요청이 성공했습니다.\",\"result\":[{\"sourceType\":\"KEPAD_RECRUITMENT\",\"enabled\":true,\"baseUrl\":\"https://api.data.go.kr\",\"pageSize\":100,\"maxPages\":100}]}"
            )))
    public ResponseEntity<com.bridgework.common.dto.ApiResponse<List<SourceConfigResponseDto>>> getSources() {
        return ResponseEntity.ok(com.bridgework.common.dto.ApiResponse.success(publicDataSyncService.getSourceConfigs()));
    }
    ...
    @ApiResponse(responseCode = "200", description = "조회 성공",
            content = @Content(examples = @ExampleObject(
                    value = "{\"code\":\"SUCCESS\",\"message\":\"요청이 성공했습니다.\",\"result\":{\"totalCount\":123456,\"sourceCounts\":[{\"sourceType\":\"KEPAD_RECRUITMENT\",\"tableName\":\"pd_kepad_recruitment\",\"rowCount\":45231}]}}"
            )))
    public ResponseEntity<com.bridgework.common.dto.ApiResponse<NormalizedCountSummaryResponseDto>> getNormalizedCounts() {
        return ResponseEntity.ok(com.bridgework.common.dto.ApiResponse.success(publicDataSyncService.getNormalizedCounts()));
    }
}
