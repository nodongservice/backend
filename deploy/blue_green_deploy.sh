...
FASTAPI_PRIMARY_HEALTH_SERVICE_NAME="${FASTAPI_PRIMARY_HEALTH_SERVICE_NAME:-bridgework-aiserver-blue}"
FASTAPI_SECONDARY_HEALTH_SERVICE_NAME="${FASTAPI_SECONDARY_HEALTH_SERVICE_NAME:-bridgework-aiserver-green}"
...
FASTAPI_HEALTH_URL="${FASTAPI_HEALTH_URL:-http://${FASTAPI_PRIMARY_HEALTH_SERVICE_NAME}:${FASTAPI_CONTAINER_PORT}/health,http://${FASTAPI_SECONDARY_HEALTH_SERVICE_NAME}:${FASTAPI_CONTAINER_PORT}/health}"
