...
FASTAPI_SERVICE_NAME="${FASTAPI_SERVICE_NAME:-host.docker.internal}"
FASTAPI_CONTAINER_PORT="${FASTAPI_CONTAINER_PORT:-19000}"
FASTAPI_FALLBACK_CONTAINER_PORT="${FASTAPI_FALLBACK_CONTAINER_PORT:-19001}"
...
FASTAPI_HEALTH_URL="${FASTAPI_HEALTH_URL:-${FASTAPI_BASE_URL}/health,http://${FASTAPI_SERVICE_NAME}:${FASTAPI_FALLBACK_CONTAINER_PORT}/health}"
